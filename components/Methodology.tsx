      ...
      <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-12 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 mb-20 items-start">
          ...
          <motion.div
            ...
            className="bg-white p-10 md:p-12 rounded-[2.5rem] shadow-2xl shadow-stone-200/50 border border-stone-100/50 relative overflow-hidden group"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            {[
              ...
              <motion.div
                ...
                className="bg-white p-8 rounded-[2rem] shadow-sm border border-stone-100 flex flex-col items-center text-center hover:shadow-2xl hover:shadow-stone-200/50 hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden"
              >
